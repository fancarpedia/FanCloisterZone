<template>
  ...
  >
    <svg viewBox="0 0 120 120">
      ...
      <circle v-if="ev.value === 1 || ev.value === 3" cx="60" cy="60" r="12" />
      <circle v-if="ev.value === 3" cx="90" cy="30" r="12" />
      <circle v-if="ev.value === 3" cx="30" cy="90" r="12" />
...
export default {
  ...
  methods: {
    onMouseEnter () {
      this.$store.commit('board/diceRollPanel', { type: 'flierdice', value: this.ev.value, action: this.ev.action })
